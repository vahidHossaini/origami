...
class globalDb
{
  ...
  {
    this.disc.run('database','config',{name:context,structure:structure},func)
      
  }
  Search(context,table,query,odata,func)
  {
    this.disc.run('database','search',{name:context,table:table,query:query,odata:odata},func)
  }
  Save(context,table,key,data,func)
  {
    this.disc.run('database','save',{name:context,table:table,key:key,data:data},func)
  }
  Delete(context,table,key,data,func)
  {
    this.disc.run('database','delete',{name:context,table:table,key:key,data:data},func)
  }
  Update(context,table,key,data,func)
  {
    this.disc.run('database','update',{name:context,table:table,key:key,data:data},func)
  } 
}
